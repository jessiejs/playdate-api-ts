...
import { Decryptable, Game, Firmware } from './types';
 ...
 */
function decrypt(iv:Buffer, key:Buffer, encryptedData:Buffer, tag:Buffer):Buffer {
 ...
 */
function getDecryptionKey(unlockKey:Buffer, item:Decryptable):Buffer {
 ...
 * @return {Buffer} The decrypted key.
 */
export function getGameDecryptionKey(unlockKey:Buffer, game:Game) {
 ...
 * @return {Buffer} The decrypted key.
 */
export function getFirmwareDecryptionKey(unlockKey:Buffer, update:Firmware) {
